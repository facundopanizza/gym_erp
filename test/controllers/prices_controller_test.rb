...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { activity_id: @price.activity_id, amount: @price.amount } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { activity_id: @price.activity_id, amount: @price.amount } }
