...
class FeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fee" do
    assert_difference('Fee.count') do
      post fees_url, params: { fee: { end_date: @fee.end_date, initial_date: @fee.initial_date, payed: @fee.payed, subscriptions_id: @fee.subscriptions_id } }
    end
  ...
  test "should update fee" do
    patch fee_url(@fee), params: { fee: { end_date: @fee.end_date, initial_date: @fee.initial_date, payed: @fee.payed, subscriptions_id: @fee.subscriptions_id } }
